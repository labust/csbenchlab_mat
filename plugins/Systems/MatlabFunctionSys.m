classdef MatlabFunctionSys < DynSystem
    ...
    properties (Constant)
        param_description = ParamSet( ...
            ParamDescriptor("fun", true), ...
            ParamDescriptor("dims", true), ...
            ParamDescriptor("a1", 0, false), ...
            ParamDescriptor("a2", 0, false), ...
            ParamDescriptor("a3", 0, false), ...
            ParamDescriptor("a4", 0, false), ...
            ParamDescriptor("a5", 0, false), ...
            ParamDescriptor("a6", 0, false), ...
            ParamDescriptor("a7", 0, false), ...
            ParamDescriptor("a8", 0, false), ...
            ParamDescriptor("differential", 0, true) ...
        );
