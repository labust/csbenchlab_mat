classdef LinearSystem < DynSystem
    ...
    properties (Constant)
        param_description = {
            ...
            ParamDescriptor("B", 1), ... 
            ParamDescriptor("C", 1), ... 
            ParamDescriptor("D", @(params) zeros(size(params.B, 2), zeros(size(params.C, 1)))), ... 
            ParamDescriptor("sat_min", @(params) -inf * ones(size(params.C, 1), 1)), ... 
            ParamDescriptor("sat_max", @(params) inf * ones(size(params.C, 1), 1)) ...
        };
