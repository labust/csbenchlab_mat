classdef DeePCHelpers
    ...
    methods (Static)
        ...
        function p = get_deepc_param_set(override_params)
            p = ParamSet( ...
                ParamDescriptor("L", true), ...
                ParamDescriptor("Tini", true), ...
                ParamDescriptor("Ts", true), ...
                ParamDescriptor("pos_control", true), ...
                ParamDescriptor("n", 1, true), ...
                ParamDescriptor("D_u", true), ...
                ParamDescriptor("D_y", true), ...
                ParamDescriptor("end_point", true), ...
                ParamDescriptor("T", false, @(params) length(params.D_u)), ...
                ParamDescriptor("R", true), ...
                ParamDescriptor("Q", true), ...
                ParamDescriptor("lambda_a", false, 0), ...
                ParamDescriptor("lambda_s", false, 0), ...
                ParamDescriptor("lambda_s_ini", false, 0), ...
                ParamDescriptor("lambda_term_u", false, 0), ...
                ParamDescriptor("lambda_term_y", false, 0), ...
                ParamDescriptor("Lc", false, @(params) params.L), ...
                ParamDescriptor("terminal_constraint_size", false, 1), ...
                ParamDescriptor("affine_constraint", false, 1), ...
                ParamDescriptor("use_overshoot_constraints", false, 1), ...
                ParamDescriptor("use_input_terminal_constraints", false, 1), ...
                ParamDescriptor("use_input_delta_constraints", false, 1), ...
                ParamDescriptor("is_strict_terminal_constraint", false, 1), ...
                ParamDescriptor("k", false, 1), ...            
                ParamDescriptor("input_delta", false, inf), ...
                ParamDescriptor("decay", false, 1), ...
                ParamDescriptor("delta_sat", false, 1), ...
                ParamDescriptor("allowed_offset_terminal", false, 0), ...
                ParamDescriptor("allowed_offset_slack", false, 0), ...
                ParamDescriptor("u_min", false, -inf), ...
                ParamDescriptor("u_max", false, inf), ...
                ParamDescriptor("y_min", false, -inf), ...
                ParamDescriptor("y_max", false, inf) ...
            );
