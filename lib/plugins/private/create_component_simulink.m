function block_path = create_component_simulink(info, lib_name, comp_type, tags, script_template, inputs, outputs, ctor_args, cfg_args, step_args, add_logging, mask_parameters, extrinsic_init, icon, size)
